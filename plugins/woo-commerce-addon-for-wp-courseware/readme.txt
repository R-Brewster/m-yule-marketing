...
This plugin adds integration between WooCommerce and WP Courseware which allows you to associate course(s) to digital products for automatic enrollment.

== Description ==
[Fly Plugins](https://flyplugins.com) presents [WooCommerce](https://wordpress.org/plugins/woocommerce/) for [WP Courseware](https://flyplugins.com/wp-courseware).
...
* [Churnly](https://flyplugins.com/churnly) - A WordPress churn reducing plugin that can automatically assist in recapturing failed recurring credit card payments with WooCommerce and Easy Digital Downloads.
