	...
	$formDetails = array(
		...
		'quiz_title' => array(
			...
			'validate' => array(
				...
				'minlen' => 1,
				'regexp' => '/^[^<>]+$/',
				'error'  => __( 'Please specify a name for your quiz or survey, up to a maximum of 300 characters, just no angled brackets (&lt; or &gt;).', 'wp-courseware' ),
			),
		),
...
function WPCW_showPage_ModifyQuiz_showQuestionEntryForms( $quizID, $page ) {
	...
	$quizItemDummy->question_multi_checkboxes_enable = 0;
